...
export type AuthenticationStatus = "unauthenticated" | "authenticated" | "pending" | "errored" | "invalid-code" | "authenticationCode";
...
export type MagicLogIn = PromiEvent<string | null, LoginWithEmailOTPEvents & {
